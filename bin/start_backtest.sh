...
q code/processes/bttickerplant.q equitysim ${KDBHDB} ${KDBSTACKID} -proctype bttickerplant -procname bttickerplant1 -localtime </dev/null >$KDBLOG/bttickerplant.txt 2>&1 &
...
echo "Starting feed ..."
q torq.q -load code/tick/backtestfeed.q ${KDBSTACKID} -proctype backtestfeed -procname backtestfeed1 -localtime -tbls quote trade -bgn 2016.05.02 -end 2016.05.02 -syms GOOG IBM MSFT </dev/null >$KDBLOG/bttickerplant.txt 2>&1 &
...
q torq.q -load code/processes/bundler.q ${KDBSTACKID} -proctype bundler -procname bundler1 -localtime -debug
