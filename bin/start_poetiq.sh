...
q torq.q -load ${KDBCODE}/processes/btctrl.q ${KDBSTACKID} -trap -proctype btctrl -procname btctrl1 -localtime -debug -new_console:s2THnc:t:'btctrl' -e 1 -.clients.enabled 0 -.usage.enabled 0 #-.zpsignore.enabled 0
